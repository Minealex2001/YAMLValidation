...
export class TrialExpiredDialog {
  ...
  render() {
    ...
    this.container.innerHTML = `
      <md-dialog id="trial-expired-dialog" open style="margin: auto; position: relative;">
        <div slot="headline">
          <span class="material-symbols-outlined" style="vertical-align: middle; margin-right: 8px;">schedule</span>
          ${Strings.get(language, 'trial.expired.title')}
        </div>
        <div slot="content">
          <p style="margin: 0; color: var(--md-sys-color-on-surface-variant);">
            ${Strings.get(language, 'trial.expired.text')}
          </p>
        </div>
        <div slot="actions">
